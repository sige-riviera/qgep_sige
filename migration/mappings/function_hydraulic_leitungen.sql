...
DROP TABLE IF EXISTS migration.map_function_hydraulic_leitungen;

CREATE TABLE migration.map_function_hydraulic_leitungen (
    old integer,
    new integer NOT NULL
);

ALTER TABLE migration.map_function_hydraulic_leitungen OWNER TO postgres;

INSERT INTO migration.map_function_hydraulic_leitungen (old, new) VALUES
