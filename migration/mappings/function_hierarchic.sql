...
DROP TABLE IF EXISTS migration.map_function_hierarchic;

CREATE TABLE migration.map_function_hierarchic (
    old integer,
    new integer NOT NULL
);


ALTER TABLE migration.map_function_hierarchic OWNER TO postgres;

INSERT INTO migration.map_function_hierarchic (old, new) VALUES 
