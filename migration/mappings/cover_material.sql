...
DROP TABLE IF EXISTS map_cover_material;

CREATE TABLE map_cover_material (
    old integer,
    new integer NOT NULL
);

ALTER TABLE sa.map_cover_material OWNER TO postgres;

INSERT INTO map_cover_material (old, new) VALUES
