...
DROP TABLE IF EXISTS migration.map_reach_material_leitungen;

CREATE TABLE migration.map_reach_material_leitungen (
    old integer,
    new integer NOT NULL
);

ALTER TABLE migration.map_reach_material_leitungen OWNER TO postgres;

INSERT INTO migration.map_reach_material_leitungen (old, new) VALUES
