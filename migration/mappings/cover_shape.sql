...
DROP TABLE IF EXISTS map_cover_shape;

CREATE TABLE map_cover_shape (
    old integer,
    new integer NOT NULL
);

ALTER TABLE sa.map_cover_shape OWNER TO postgres;

INSERT INTO map_cover_shape (old, new) VALUES
